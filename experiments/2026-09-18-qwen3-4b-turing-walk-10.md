...
- machine during the run: {"samples":3,"gpuPercent":{"min":0,"max":98,"mean":65},"vramGiB":{"min":0.39,"max":3.89,"mean":2.7},"load":{"min":16.01,"max":18.13,"mean":17.1},"memoryFreePercent":{"min":74,"max":85,"mean":77.7},"throttledSamples":0,"worstSpeedLimit":100}

## Driver log

- 2026-09-18T14:39:51.915Z opened http://127.0.0.1:8765/ in 153.0.8010.50 (darwin arm64, Apple M1 Max)
...
- 2026-09-18T14:39:52.027Z loading: Checking this device before downloading…
- 2026-09-18T14:39:57.032Z loading: Ready. Inference runs on this device.
...
- machine at start: gpu 98% · vram 0.39 GiB · load 16.01 · mem 85% free (normal) · no throttling recorded
- 2026-09-18T14:40:35.223Z run stopped: Root resolved
- machine during the run: gpu 65% mean, 98% peak · vram up to 3.89 GiB · load up to 18.13 · no throttling in 3 samples
...
model Qwen3-4B-q4f16_1-MLC · prompt walk-10/asks-3/sentence:list,section:list,missing:search,question:one,article:snippets,confirm:yesno · created 2026-09-18T14:39:57.246Z · exported 2026-09-18T14:40:35.338Z
...
model latency ms: median 1735 · max 2918 · n 23
worth a look:
